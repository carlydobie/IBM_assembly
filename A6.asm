...
BUILD    CSECT
         ...
         LM    2,4,0(1)         Load parameter list into 2-4
READ     XREAD 0(0,4),80        Read line of input
...
ENDPRINT L     13,4(0,13)        Point R13 at caller's save area.              
         ...
         LTORG
HEAD     DC    CL1'1'
         DC    CL50'        Odds and Ends Customer Data         Page: '
PAGE     DS    CL3
PNUM     DS    PL2
LINE     DC    CL1'0'           Output line, carriage control
PFNAME   DS    CL10             First name output
PLNAME   DS    CL10             Last name output 
PID      DS    CL8              ID number output
PBAL     DS    CL10             Balance output
...
TRANS    CSECT
         ...
         USING TRANSACT,4
TLOOP    XREAD 0(0,4),80        Read line of file
         BC    B'0100',ENDTLOOP End loop if at EOF
